...
public class SiteController {
    ...
    private final List<User> listUsers = new ArrayList<>(); private final List<Country> listCountries = new ArrayList<>();

    @GetMapping("/api/travels")
    public List<Country> getDestinations(@RequestParam("username") String username) {

        List<Country> tmpList = new ArrayList<>(); Country country2 = new Country("spain", 32.9); listCountries.add(country2); User myUser = new User("aa@aa.fr", "aa", Weather.WARMER,25);
